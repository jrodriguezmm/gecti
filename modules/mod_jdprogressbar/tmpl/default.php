...
<div id="jd-progressbar" class="jdpb">
	<?php foreach($items as $key => $item) { ?> 
		<?php if($percenateg_position == "outside"){ ?>
			...
			<div class="jdpb jdpb-bar <?php echo $barType; ?>" style="height: <?php echo $barHeight; ?>px; background-color: <?php echo $barProgressColor; ?>;">
				<div id="jd_progressbar<?php echo $module->id.$key; ?>" class="jdpb--bar progressbar-not-started" style="background-color:<?php echo modJDprogressBarsHelper::GetColor($item->type,$params); ?>;"></div>
			</div>			
		<?php }else{ ?>
			<div class="jdpb jdpb-bar <?php echo $barType; ?>"  style="height: <?php echo $barHeight; ?>px; background-color: <?php echo $barProgressColor; ?>;" >
				<div id="jd_progressbar<?php echo $module->id.$key; ?>" class="jdpb--bar progressbar-not-started" style="background-color:<?php echo modJDprogressBarsHelper::GetColor($item->type,$params); ?>">
