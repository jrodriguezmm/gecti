<?php /* /Applications/MAMP/htdocs/astroid230/administrator/components/com_akeeba/ViewTemplates/Backup/default.blade.php */ ?>
<?php
/**
...
<div id="backup-setup" class="akeeba-panel--primary">
	...
	<div id="akeeba-fatal-outputdirectory" class="akeeba-block--failure">
		...
		<p>
			<?php echo \Joomla\CMS\Language\Text::sprintf('COM_AKEEBA_BACKUP_ERROR_UNWRITABLEOUTPUT_COMMON', 'index.php?option=com_akeeba&view=Configuration', 'https://www.akeebabackup.com/warnings/q001.html'); ?>
		</p>
	</div>
	<?php endif; ?>
	...
	<form id="dummyForm" class="akeeba-form--horizontal" style="display: <?php echo $this->unwriteableOutput ? 'none' : 'block'; ?>;">
		...
		<div class="akeeba-form-group">
			<label for="jpskey">
				<?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFIG_JPS_KEY_TITLE'); ?>
			</label>
            <input type="password" name="jpskey" value="<?php echo $this->escape($this->jpsPassword); ?>" size="50" id="jpskey" autocomplete="off" />
            <span class="akeeba-help-text"><?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFIG_JPS_KEY_DESCRIPTION'); ?></span>
		</div>
		<?php endif; ?>
		...
		<div class="akeeba-form-group">
			<label for="angiekey">
				<?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFIG_ANGIE_KEY_TITLE'); ?>
			</label>
            <input type="password" name="angiekey" value="<?php echo $this->escape($this->ANGIEPassword); ?>"  size="50" id="angiekey" autocomplete="off" />
            <span class="akeeba-help-text"><?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFIG_ANGIE_KEY_DESCRIPTION'); ?></span>
		</div>
		<?php endif; ?>
...
<div id="angie-password-warning" class="akeeba-block--warning" style="display: none">
    ...
    <p><?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_BACKUP_ANGIE_PASSWORD_WARNING_3'); ?></p>
</div>
		...
		<div id="errorframe">
			...
			<div class="akeeba-block--info" id="error-panel-troubleshooting">
				<p>
					...
					<?php echo \Joomla\CMS\Language\Text::sprintf('COM_AKEEBA_BACKUP_TEXT_RTFMTOSOLVE', 'https://www.akeebabackup.com/documentation/troubleshooter/abbackup.html?utm_source=akeeba_backup&utm_campaign=backuperrorlink'); ?>
				</p>
				<p>
					<?php if(AKEEBA_PRO): ?>
					<?php echo \Joomla\CMS\Language\Text::sprintf('COM_AKEEBA_BACKUP_TEXT_SOLVEISSUE_PRO', 'https://www.akeebabackup.com/support.html?utm_source=akeeba_backup&utm_campaign=backuperrorpro'); ?>
					<?php else: ?>
					<?php echo \Joomla\CMS\Language\Text::sprintf('COM_AKEEBA_BACKUP_TEXT_SOLVEISSUE_CORE', 'https://www.akeebabackup.com/subscribe.html?utm_source=akeeba_backup&utm_campaign=backuperrorcore','https://www.akeebabackup.com/support.html?utm_source=akeeba_backup&utm_campaign=backuperrorcore'); ?>
					<?php endif; ?>
