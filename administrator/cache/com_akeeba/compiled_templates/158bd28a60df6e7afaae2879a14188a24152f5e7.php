<?php /* /Applications/MAMP/htdocs/astroid230/administrator/components/com_akeeba/ViewTemplates/ControlPanel/sidebar_status.blade.php */ ?>
<?php
/**
            ...
            <p style="margin: 0.5em 0">
                <a href="index.php?option=com_akeeba&view=ControlPanel&task=reloadUpdateInformation"
                   class="akeeba-btn--dark">
                    <?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CPANEL_MSG_RELOADUPDATE'); ?>
                </a>
            </p>
        <?php else: ?>
            <a href="index.php?option=com_akeeba&view=ControlPanel&task=reloadUpdateInformation"
