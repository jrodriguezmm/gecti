<?php /* /Applications/MAMP/htdocs/astroid230/administrator/components/com_akeeba/ViewTemplates/Manage/default.blade.php */ ?>
<?php
/**
...
<div class="akeeba-block--info">
    ...
    <p>
		<?php echo \Joomla\CMS\Language\Text::sprintf('COM_AKEEBA_BUADMIN_LABEL_HOWDOIRESTORE_TEXT_' . (AKEEBA_PRO ? 'PRO' : 'CORE'), 'https://www.akeebabackup.com/videos/1212-akeeba-backup-core/1618-abtc04-restore-site-new-server.html', 'index.php?option=com_akeeba&view=Transfer', 'https://www.akeebabackup.com/latest-kickstart-core.zip'); ?>
    </p>
    <p>
        <?php if(!AKEEBA_PRO): ?>
            <?php echo \Joomla\CMS\Language\Text::sprintf('COM_AKEEBA_BUADMIN_LABEL_HOWDOIRESTORE_TEXT_CORE_INFO_ABOUT_PRO', 'https://www.akeebabackup.com/products/akeeba-backup.html'); ?>
        <?php endif; ?>
    </p>
</div>
