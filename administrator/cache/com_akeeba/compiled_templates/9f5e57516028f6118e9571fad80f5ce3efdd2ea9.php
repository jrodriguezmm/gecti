<?php /* /Applications/MAMP/htdocs/astroid230/administrator/components/com_akeeba/ViewTemplates/ControlPanel/warnings.blade.php */ ?>
<?php
/**
...
<?php if($this->isOutputDirectoryUnderSiteRoot): ?>
    ...
    <div class="akeeba-block--failure" id="outDirSystem" style="display: none">
        <h3><?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CPANEL_HEAD_OUTDIR_INVALID'); ?></h3>
        <p>
...
<?php if ( ! (empty($this->frontEndSecretWordIssue))): ?>
    <div class="akeeba-block--failure">
        <h3><?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CPANEL_ERR_FESECRETWORD_HEADER'); ?></h3>
...
<?php if ( ! ($this->areMediaPermissionsFixed)): ?>
    <div id="notfixedperms" class="akeeba-block--failure">
        <h3><?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONTROLPANEL_WARN_WARNING'); ?></h3>
...
<?php if($this->needsDownloadID): ?>
    <div class="akeeba-block--warning">
        ...
        <p>
            <?php echo \Joomla\CMS\Language\Text::sprintf('COM_AKEEBA_LBL_CPANEL_NEEDSDLID','https://www.akeebabackup.com/download/official/add-on-dlid.html'); ?>
        </p>
...
<?php if($this->coreWarningForDownloadID): ?>
    <div class="akeeba-block--warning">
        <?php echo \Joomla\CMS\Language\Text::sprintf('COM_AKEEBA_LBL_CPANEL_NEEDSUPGRADE','https://www.akeebabackup.com/videos/1212-akeeba-backup-core/1617-abtc03-upgrade-core-professional.html'); ?>
    </div>
<?php endif; ?>
